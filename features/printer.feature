Feature: Table printer
  ...
  Scenario: simple index and valid data
    Given a gherkin table as input
      ...
      | index_col | float_col | str_col             | dict_col  | list_col | ordered_dict_col         | ordered_dict_col_2 |
  ...
  Scenario: handle None, nan, NaT
    Given a gherkin table as input
      ...
      | index_col | float_col | str_col     | datetime_col   | dict_col  | list_col | ordered_dict_col         | ordered_dict_col_2 |
