...
def dataframe_to_table(df):
    ...
    as_string.loc[:, cols_with_potential_nans] = as_string.loc[:, cols_with_potential_nans].replace('nan', '')
    as_string.loc[:, cols_with_potential_nats] = as_string.loc[:, cols_with_potential_nats].replace('NaT', '')
